                ...
                <div class="checkout-right">
                      ...
                      <tbody>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                              <td><?php echo $row['name'] ?><strong><?php echo $row['quantity'] . "x" . $row['price'] ?></strong></td>
                              <td><?php echo $v = $row['quantity'] * $row['price'] ?></td>
                            </tr>
                          <?php } ?>
                        <?php } ?>
                      </tbody>
                  ...
                  <div class="aa-payment-method">
                    <label for="cashdelivery"><input type="radio" id="cashdelivery" name="optionsRadios"> Cash on
                      Delivery </label>
                    <label for="paypal"><input type="radio" id="paypal" name="optionsRadios" checked> Via Paypal
                    </label>
